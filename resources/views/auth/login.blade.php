...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="{{ asset('assets/images/ico-wisesa.svg')}}" type="image/png" />
    <!--plugins-->
                                    ...
                                    <div class="form-body">
                                        <form method="POST" action="{{ route('login') }}" class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="email" class="form-control" id="inputEmailAddress" name="email" :value="old('email')" required autofocus autocomplete="username" />
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password" class="form-control border-end-0" id="inputChoosePassword" name="password" required autocomplete="current-password" />
